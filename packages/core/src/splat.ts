...
export const splat: Linter.Config['rules'] = {
  ...
  'indent': ['warn', SharedEditorConfig.indent_size],
  ...
  'max-len': [
    'warn',
    {
      code: SharedEditorConfig.max_line_length,
      tabWidth: SharedEditorConfig.indent_size,
      ignoreComments: true,
    },
  ],
